...
if ( !function_exists( 'yogastudio_sc_title_reg_shortcodes' ) ) {
	...
	function yogastudio_sc_title_reg_shortcodes() {
		...
		yogastudio_sc_map("trx_title", array(
			...
			"params" => array(
				...
				"lined_icon" => array(
					"title" => esc_html__("Lined", 'trx_utils'),
					"desc" => wp_kses_data( __("line before and afte image", 'trx_utils') ),
					"dependency" => array(
								'style' => array('iconed')
							),
					"value" => "no",
				...
				"image" => array(
					...
					"type" => "images",
					"size" => "small",
					"options" => yogastudio_get_sc_param('images')
				),
				"picture" => array(
		...
		vc_map( array(
			...
			"params" => array(
				...
				array(
						...
						"heading" => esc_html__("Lines", 'trx_utils'),
						"description" => esc_html__("Use before and after lines", 'trx_utils'),
						"admin_label" => true,
						'dependency' => array(
							'element' => 'style',
							'value' => 'iconed'
				...
				array(
					...
					"value" => yogastudio_get_sc_param('images'),
					"type" => "dropdown"
				),
				array(
					"param_name" => "picture",
