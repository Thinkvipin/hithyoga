...
*/
yogastudio_storage_set('sc_blogger_busy', false);
...
if (!function_exists('yogastudio_sc_blogger')) {	
	function yogastudio_sc_blogger($atts, $content=null){	
		...
		yogastudio_storage_set('sc_blogger_busy', true);
		yogastudio_storage_set('sc_blogger_counter', 0);
		...
		while ( $query->have_posts() ) { $query->the_post();
			...
			yogastudio_storage_inc('sc_blogger_counter');
	
			$args = array(
				'layout' => $style,
				'show' => false,
				'number' => yogastudio_storage_get('sc_blogger_counter'),
				'add_view_more' => false,
		...
		if (!yogastudio_param_is_off($filters)) {
			...
			if ($filters_list) {
				yogastudio_storage_concat('js_code', '
...
if ( !function_exists( 'yogastudio_sc_blogger_reg_shortcodes' ) ) {
	...
	function yogastudio_sc_blogger_reg_shortcodes() {
		...
		yogastudio_sc_map("trx_blogger", array(
			...
			"params" => array(
				...
				"style" => array(
					...
					"value" => "accordion",
					"type" => "select",
					"options" => yogastudio_get_sc_param('blogger_styles')
				),
				"filters" => array(
					...
					"dir" => "horizontal",
					"type" => "checklist",
					"options" => yogastudio_get_sc_param('filters')
				),
				"hover" => array(
					...
					"value" => "",
					"type" => "select",
					"options" => yogastudio_get_sc_param('hovers')
				),
				"hover_dir" => array(
					...
					"value" => "left_to_right",
					"type" => "select",
					"options" => yogastudio_get_sc_param('hovers_dir')
				),
				"dir" => array(
				...
				"post_type" => array(
					...
					"value" => "post",
					"type" => "select",
					"options" => yogastudio_get_sc_param('posts_types')
				),
				"ids" => array(
				...
				"only" => array(
					...
					"value" => "no",
					"type" => "select",
					"options" => yogastudio_get_sc_param('formats')
				),
				"scroll" => array(
				...
				"location" => array(
					...
					"value" => "default",
					"type" => "select",
					"options" => yogastudio_get_sc_param('locations')
				),
				"rating" => array(
		...
		vc_map( array(
			...
			"params" => array(
				array(
					...
					"std" => "accordion",
					"class" => "",
					"value" => array_flip(yogastudio_get_sc_param('blogger_styles')),
					"type" => "dropdown"
				),
				array(
					"param_name" => "filters",
					...
					"admin_label" => true,
					"class" => "",
					"value" => array_flip(yogastudio_get_sc_param('filters')),
					"type" => "dropdown"
				),
				array(
					"param_name" => "hover",
					...
					"class" => "",
					"value" => array_flip(yogastudio_get_sc_param('hovers')),
					'dependency' => array(
						'element' => 'style',
				...
				array(
					...
					"class" => "",
					"value" => array_flip(yogastudio_get_sc_param('hovers_dir')),
					'dependency' => array(
						'element' => 'style',
						'value' => array('portfolio_2','portfolio_3','portfolio_4','grid_2','grid_3','grid_4','square_2','square_3','square_4','short_2','short_3','short_4','colored_2','colored_3','colored_4')
					),
				...
				array(
					...
					"value" => array_flip(yogastudio_get_sc_param('locations')),
					"type" => "dropdown"
				),
				array(
					"param_name" => "dir",
				...
				array(
					...
					"class" => "",
					"value" => array_flip(yogastudio_get_sc_param('posts_types')),
					"type" => "dropdown"
				),
				array(
					"param_name" => "ids",
				...
				array(
					...
					"class" => "",
					"group" => esc_html__('Query', 'trx_utils'),
					"value" => array_flip(yogastudio_get_sc_param('formats')),
					"type" => "dropdown"
				),
				array(
					"param_name" => "scroll",
