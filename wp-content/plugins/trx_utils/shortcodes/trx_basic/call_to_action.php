...
if ( !function_exists( 'yogastudio_sc_call_to_action_reg_shortcodes' ) ) {
	...
	function yogastudio_sc_call_to_action_reg_shortcodes() {
		...
		yogastudio_sc_map("trx_call_to_action", array(
			...
			"params" => array(
				...
				"accent" => array(
					...
					"desc" => wp_kses_data( __("Fill entire block with Accent1 color from current color scheme", 'trx_utils') ),
					"divider" => true,
					"value" => "no",
					"type" => "switch",
		...
		vc_map( array(
			...
			"params" => array(
				...
				array(
					...
					"description" => wp_kses_data( __("Fill entire block with Accent1 color from current color scheme", 'trx_utils') ),
					"class" => "",
