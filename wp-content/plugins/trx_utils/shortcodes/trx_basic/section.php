...
if (!function_exists('yogastudio_sc_section')) {	
	function yogastudio_sc_section($atts, $content=null){	
		...
		if (yogastudio_param_is_on($dedicated)) {
			if (yogastudio_storage_get('sc_section_dedicated')=='') {
				yogastudio_storage_set('sc_section_dedicated', $output);
			}
			$output = '';
		}
...
if ( !function_exists( 'yogastudio_sc_section_reg_shortcodes' ) ) {
	...
	function yogastudio_sc_section_reg_shortcodes() {
		...
		$sc = array(
			...
			"params" => array(
				...
				"columns" => array(
					...
					"value" => "none",
					"type" => "checklist",
					"options" => yogastudio_get_sc_param('columns')
				), 
				"pan" => array(
				...
				"scroll_controls" => array(
					...
					"value" => "hide",
					"type" => "checklist",
					"options" => yogastudio_get_sc_param('controls')
				),
				"scheme" => array(
		...
		yogastudio_sc_map("trx_block", $sc);
		...
		yogastudio_sc_map("trx_section", $sc);
	}
}
...
if ( !function_exists( 'yogastudio_sc_section_reg_shortcodes_vc' ) ) {
	...
	function yogastudio_sc_section_reg_shortcodes_vc() {
		...
		$sc = array(
			...
			"description" => wp_kses_data( __("Container for any block ([section] analog - to enable nesting)", 'trx_utils') ),
			...
			"params" => array(
				...
				array(
					...
					"admin_label" => true,
					"class" => "",
					"value" => array_flip(yogastudio_get_sc_param('columns')),
					"type" => "dropdown"
				),
				array(
					"param_name" => "title",
				...
				array(
					...
					"value" => array_flip(yogastudio_get_sc_param('controls')),
					"type" => "dropdown"
				),
				array(
					"param_name" => "scheme",
		...
		$sc["description"] = wp_kses_data( __("Container for any section ([block] analog - to enable nesting)", 'trx_utils') );
