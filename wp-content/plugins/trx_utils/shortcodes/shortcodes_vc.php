...
if ( !function_exists( 'yogastudio_get_vc_param' ) ) {
	function yogastudio_get_vc_param($prm) {
		return yogastudio_storage_get_array('vc_params', $prm);
	}
}

// Set vc_param value
if ( !function_exists( 'yogastudio_set_vc_param' ) ) {
	function yogastudio_set_vc_param($prm, $val) {
		yogastudio_storage_set_array('vc_params', $prm, $val);
	}
}
...
//			vc_remove_element("vc_images_carousel");
			...
			yogastudio_storage_set('vc_params', array(
				...
				'animation' => array(
					...
					"group" => esc_html__('ID &amp; Class', 'trx_utils'),
					"class" => "",
					"value" => array_flip(yogastudio_get_sc_param('animations')),
					"type" => "dropdown"
				),
				...
				'margin_top' => array(
					...
					"group" => esc_html__('Size &amp; Margins', 'trx_utils'),
					"std" => "inherit",
					"value" => array_flip(yogastudio_get_sc_param('margins')),
					"type" => "dropdown"
				),
