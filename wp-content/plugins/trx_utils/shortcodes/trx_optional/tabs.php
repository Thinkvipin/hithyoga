...
if (!function_exists('yogastudio_sc_tabs')) {	
	function yogastudio_sc_tabs($atts, $content = null) {
		...
		yogastudio_storage_set('sc_tab_data', array(
			'counter'=> 0,
            'scroll' => $scroll,
		...
		$sc_tab_titles = yogastudio_storage_get_array('sc_tab_data', 'titles');
...
if (!function_exists('yogastudio_sc_tab')) {	
	function yogastudio_sc_tab($atts, $content = null) {
		...
		yogastudio_storage_inc_array('sc_tab_data', 'counter');
		$counter = yogastudio_storage_get_array('sc_tab_data', 'counter');
		if (empty($id))
			$id = !empty($tab_id) ? $tab_id : yogastudio_storage_get_array('sc_tab_data', 'id').'_'.intval($counter);
		$sc_tab_titles = yogastudio_storage_get_array('sc_tab_data', 'titles');
		...
		yogastudio_storage_set_array('sc_tab_data', 'titles', $sc_tab_titles);
		$output = '<div id="'.esc_attr($id).'"'
					.' class="sc_tabs_content' 
						...
						. ($css!='' ? ' style="'.esc_attr($css).'"' : '') 
						. '>' 
				. (yogastudio_param_is_on(yogastudio_storage_get_array('sc_tab_data', 'scroll'))
					? '<div id="'.esc_attr($id).'_scroll" class="sc_scroll sc_scroll_vertical" style="height:'.(yogastudio_storage_get_array('sc_tab_data', 'height') != '' ? yogastudio_storage_get_array('sc_tab_data', 'height') : '200px').';"><div class="sc_scroll_wrapper swiper-wrapper"><div class="sc_scroll_slide swiper-slide">'
					: '')
...
if ( !function_exists( 'yogastudio_sc_tabs_reg_shortcodes' ) ) {
	...
	function yogastudio_sc_tabs_reg_shortcodes() {
		...
		yogastudio_sc_map("trx_tabs", array(
