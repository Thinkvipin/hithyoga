					...
					. '>
						<div class="search_form_wrap">
							<form role="search" method="get" class="search_form" action="' . esc_url(home_url('/')) . '">
								<button type="submit" class="search_submit icon-search" title="' . ($state=='closed' ? esc_attr__('Open search', 'trx_utils') : esc_attr__('Start search', 'trx_utils')) . '" data-title="'.esc_html__('Search', 'trx_utils').'"></button>
...
if ( !function_exists( 'yogastudio_sc_search_reg_shortcodes' ) ) {
	...
	function yogastudio_sc_search_reg_shortcodes() {
		...
		yogastudio_sc_map("trx_search", array(
			"title" => esc_html__("Search", 'trx_utils'),
