...
if (!function_exists('yogastudio_widget_twitter_theme_setup')) {
	add_action( 'yogastudio_action_before_init_theme', 'yogastudio_widget_twitter_theme_setup', 1 );
	function yogastudio_widget_twitter_theme_setup() {

		// Register shortcodes in the shortcodes list
		if (function_exists('yogastudio_exists_visual_composer') && yogastudio_exists_visual_composer())
			add_action('yogastudio_action_shortcodes_list_vc','yogastudio_widget_twitter_reg_shortcodes_vc');
	}
}

// Load widget
if (!function_exists('yogastudio_widget_twitter_load')) {
...
class yogastudio_widget_twitter extends WP_Widget {
	...
	function __construct() {
		...
		parent::__construct( 'yogastudio_widget_twitter', esc_html__('YogaStudio - Twitter', 'trx_utils'), $widget_ops );
	}
	...
	function yogastudio_sc_widget_twitter($atts, $content=null){	
		...
		if ( is_object( $wp_widget_factory ) && isset( $wp_widget_factory->widgets, $wp_widget_factory->widgets[ $type ] ) ) {
			...
			$output = '<div' . ($id ? ' id="'.esc_attr($id).'"' : '')
						...
						. '">';
			ob_start();
			the_widget( $type, $atts, yogastudio_prepare_widgets_args(yogastudio_storage_get('widgets_args'), $id ? $id.'_widget' : 'widget_twitter', 'widget_twitter') );
...
if (!function_exists('yogastudio_widget_twitter_reg_shortcodes_vc')) {
	function yogastudio_widget_twitter_reg_shortcodes_vc() {
