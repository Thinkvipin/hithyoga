...
class yogastudio_widget_socials extends WP_Widget {
	...
	function __construct() {
		...
		parent::__construct( 'yogastudio_widget_socials', esc_html__('YogaStudio - Show logo and social links', 'trx_utils'), $widget_ops );
	}
	...
	function widget( $args, $instance ) {
		...
		<div class="widget_inner">
            <?php
				...
				if ($show_icons) {
					yogastudio_show_layout(yogastudio_sc_socials(array('size' => "tiny", 'shape' => 'round')));
				}
			?>
		</div>
	...
	function form( $instance ) {
		...
		<p>
            ...
            <?php
			yogastudio_show_layout(yogastudio_show_custom_field($this->get_field_id( 'logo_media' ), array('type'=>'mediamanager', 'media_field_id'=>$this->get_field_id( 'logo_image' )), null));
			if ($logo_image) {
			?>
	...
	function yogastudio_sc_widget_socials($atts, $content=null){	
		...
		if ( is_object( $wp_widget_factory ) && isset( $wp_widget_factory->widgets, $wp_widget_factory->widgets[ $type ] ) ) {
			$output = '<div' . ($id ? ' id="'.esc_attr($id).'"' : '')
						...
						. '">';
			ob_start();
			the_widget( $type, $atts, yogastudio_prepare_widgets_args(yogastudio_storage_get('widgets_args'), $id ? $id.'_widget' : 'widget_socials', 'widget_socials') );
