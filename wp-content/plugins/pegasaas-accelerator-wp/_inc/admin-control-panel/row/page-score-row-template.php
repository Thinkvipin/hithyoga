<tr class='page-data-item'>
	...
	<td>
	  ...
	  <a data-toggle='tooltip' title='Edit Page Level Settings' class='pull-right external-link' style='margin-left: 10px;' href='post.php?post={{ id }}&action=edit#pegasaas_page_post_options'><i class='material-icons'>edit</i></a>
