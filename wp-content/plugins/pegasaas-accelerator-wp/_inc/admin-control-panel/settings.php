...
<div class='subscribed-features settings-container'>
	...
	<ul  class='nav'>
		...
		<li class='manual-only-configuration'><a href='#settings-section-general-resource-optimization'><i class='material-icons'>toys</i> General Resource Optimization</a></li>
		...
		<li class='manual-only-configuration'><a href='#settings-section-misc-resource-delivery'><i class='material-icons'>font_download</i> Misc Resource Delivery</a></li>
					...
					<?php foreach ($section_features as $feature) { 
						...
						?> 
						  ...
						  <a href="#" data-target="#<?php echo $feature; ?>-panel" class="list-group-item feature-container 
																						  ...
																						  <?php if (($feature_settings['status'] == "0" || $feature_settings['status'] == "" || $is_premium_feature)  && ($feature != "display_mode" && $feature != "display_level" && $feature != "speed_configuration" && $feature != "coverage"  &&  $feature != "blog" && $feature != "updater" && $feature != "ssl_warning_override")) { print "feature-disabled"; } ?> 
					...
					echo $display_name; ?> 
							  <i class='fa fa-caret-right fa-right'></i>
							   ...
							   <?php if (PegasaasAccelerator::$settings['status'] > 0 && 
										 ...
										 $feature != "blog" && 
										 $feature != "updater" && 
										 $feature != "ssl_warning_override" && 
										$feature != "lazy_load_third_party_vendor_scripts") { ?>
