...
if (!yogastudio_param_is_off($sidebar_show) && is_active_sidebar($sidebar_name)) {
	yogastudio_profiler_add_point(esc_html__('Before Sidebar', 'yogastudio'));
	?>
	<div class="sidebar widget_area scheme_<?php echo esc_attr($sidebar_scheme); ?>" role="complementary">
		<div class="sidebar_inner widget_area_inner">
			...
			yogastudio_storage_set('current_sidebar', 'main');
	...
	<?php
	yogastudio_profiler_add_point(esc_html__('After Sidebar', 'yogastudio'));
}
?>