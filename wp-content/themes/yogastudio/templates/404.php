	...
	function yogastudio_template_404_output() {
		...
		<img class="background_cover" src="/wp-content/themes/yogastudio/images/404back.png">
			<div class="post_content">
				...
				<p class="page_description"><?php echo wp_kses_data( sprintf( __('Can\'t find what you need? Take a moment and do<br>a search below or start from <a href="%s">our homepage</a>.', 'yogastudio'), esc_url(home_url('/')) ) ); ?></p>
				<div class="page_search"><?php if(function_exists('yogastudio_sc_search')) yogastudio_show_layout(yogastudio_sc_search(array('state'=>'fixed', 'title'=>__('To search type and hit enter', 'yogastudio')))); ?></div>
			</div>
		</article>
		<?php
	}
