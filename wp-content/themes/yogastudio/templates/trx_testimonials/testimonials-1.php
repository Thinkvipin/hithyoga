...
if ( !function_exists( 'yogastudio_template_testimonials_1_theme_setup' ) ) {
	add_action( 'yogastudio_action_before_init_theme', 'yogastudio_template_testimonials_1_theme_setup', 1 );
	function yogastudio_template_testimonials_1_theme_setup() {
		yogastudio_add_template(array(
			...
			'title'  => esc_html__('Testimonials /Style 1/', 'yogastudio'),
...
// Template output
if ( !function_exists( 'yogastudio_template_testimonials_1_output' ) ) {
	function yogastudio_template_testimonials_1_output($post_options, $post_data) {
		$show_title = true;
