	...
	function yogastudio_template_clients_2_output($post_options, $post_data) {
		...
		?>
			<div<?php echo !empty($post_options['tag_id']) ? ' id="'.esc_attr($post_options['tag_id']).'"' : ''; ?>
				...
				<div class="sc_client_image"><?php yogastudio_show_layout($post_options['client_image']); ?>
					<div class="sc_client_hover">
						<div class="sc_client_info">
							<div class="sc_client_description"><?php yogastudio_show_layout(yogastudio_strshort($post_data['post_excerpt'], isset($post_options['descr']) ? $post_options['descr'] : yogastudio_get_custom_option('post_excerpt_maxlength_masonry'))); ?></div>
							...
							<div class="sc_client_position"><?php yogastudio_show_layout($post_options['client_position']);?></div>
						</div>
					</div>
				</div>
			</div>
