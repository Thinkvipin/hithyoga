...
if ($post_data['post_edit_enable']) {
	...
	wp_enqueue_style ( 'fontello-admin',        yogastudio_get_file_url('css/fontello-admin/css/fontello-admin.css'), array(), null);
	wp_enqueue_style ( 'frontend-editor-style', yogastudio_get_file_url('js/core.editor/core.editor.css'), array(), null );
	wp_enqueue_script( 'frontend-editor',       yogastudio_get_file_url('js/core.editor/core.editor.js'),  array(), null, true );
