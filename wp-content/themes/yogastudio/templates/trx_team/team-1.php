...
if ( !function_exists( 'yogastudio_template_team_1_theme_setup' ) ) {
	add_action( 'yogastudio_action_before_init_theme', 'yogastudio_template_team_1_theme_setup', 1 );
	function yogastudio_template_team_1_theme_setup() {
		yogastudio_add_template(array(
			'layout' => 'team-1',
			'template' => 'team-1',
			'mode'   => 'team',
			/*'container_classes' => 'sc_slider_nopagination sc_slider_controls sc_slider_controls_bottom',*/
			'title'  => esc_html__('Team /Style 1/', 'yogastudio'),
...
// Template output
if ( !function_exists( 'yogastudio_template_team_1_output' ) ) {
	function yogastudio_template_team_1_output($post_options, $post_data) {
		$show_title = true;
