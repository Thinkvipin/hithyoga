...
if (!function_exists('yogastudio_template_masonry_add_scripts')) {
	//Handler of add_action('yogastudio_action_blog_scripts', 'yogastudio_template_masonry_add_scripts');
		...
		<div class="isotope_item isotope_item_<?php echo esc_attr($style); ?> isotope_item_<?php echo esc_attr($post_options['layout']); ?> isotope_column_<?php echo esc_attr($columns); ?>
			...
			<div class="post_content isotope_item_content">
				...
				if (!$post_data['post_protected'] && $post_options['info']) {
					$post_options['info_parts'] = array('author'=>true, 'terms'=>false, 'counters'=>false);
				...
				if ($show_title) {
					if (!isset($post_options['links']) || $post_options['links']) {
						?>
						<h5 class="post_title"><a href="<?php echo esc_url($post_data['post_link']); ?>"><?php yogastudio_show_layout($post_data['post_title']); ?></a></h5>
						<?php
					} else {
						?>
						<h5 class="post_title"><?php yogastudio_show_layout($post_data['post_title']); ?></h5>
						<?php
					}
				}
