...
if ( !function_exists( 'yogastudio_template_single_team_output' ) ) {
	function yogastudio_template_single_team_output($post_options, $post_data) {
		...
		if ($show_title && $post_options['location'] == 'center' && yogastudio_get_custom_option('show_page_title')=='no') {
			?>
			<<?php echo esc_html($title_tag); ?> itemprop="headline" class="post_title entry-title"><span class="post_icon <?php echo esc_attr($post_data['post_icon']); ?>"></span><?php yogastudio_show_layout($post_data['post_title']); ?></<?php echo esc_html($title_tag); ?>>
			<?php 
		}
		...
		if ($show_title && $post_options['location'] != 'center' && yogastudio_get_custom_option('show_page_title')=='no') {
			?>
			<<?php echo esc_html($title_tag); ?> itemprop="name" class="post_title entry-title"><span class="post_icon <?php echo esc_attr($post_data['post_icon']); ?>"></span><?php yogastudio_show_layout($post_data['post_title']); ?></<?php echo esc_html($title_tag); ?>>
			<?php 
		}
