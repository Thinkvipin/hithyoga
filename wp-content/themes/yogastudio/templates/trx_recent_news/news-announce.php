		...
		?><article id="post-<?php echo esc_html($post_data['post_id']); ?>" 
			...
			<div class="post_featured">
				...
				<div class="post_info">
					...
					<h5 class="post_title entry-title"><a href="<?php echo esc_url($post_data['post_link']); ?>" rel="bookmark"><?php yogastudio_show_layout($post_data['post_title']); ?></a></h5>
					<?php if ( in_array($post_data['post_type'], array('post', 'attachment')) ) { ?>
						<div class="post_meta">
							<span class="post_meta_author"><?php yogastudio_show_layout($post_data['post_author_link']); ?></span>
