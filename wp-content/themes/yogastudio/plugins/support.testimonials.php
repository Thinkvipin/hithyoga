...
if (!function_exists('yogastudio_testimonial_theme_setup')) {
	...
	function yogastudio_testimonial_theme_setup() {
		...
		add_filter('trx_utils_filter_override_options',		'yogastudio_testimonial_add_override_options');
		...
		// Meta box fields
		yogastudio_storage_set('testimonial_override_options', array(
			...
			'fields' => array(
				"testimonial_author" => array(
					...
					"desc" => wp_kses_data( __("Name of the testimonial's author", 'yogastudio') ),
					"class" => "testimonial_author",
					"std" => "",
					"type" => "text"),
				"testimonial_position" => array(
					"title" => esc_html__("Author's position",  'yogastudio'),
					"desc" => wp_kses_data( __("Position of the testimonial's author", 'yogastudio') ),
					"class" => "testimonial_author",
					"std" => "",
					"type" => "text"),
				"testimonial_email" => array(
					"title" => esc_html__("Author's e-mail",  'yogastudio'),
					"desc" => wp_kses_data( __("E-mail of the testimonial's author - need to take Gravatar (if registered)", 'yogastudio') ),
					"class" => "testimonial_email",
					"std" => "",
					"type" => "text"),
				"testimonial_link" => array(
					"title" => esc_html__('Testimonial link',  'yogastudio'),
					"desc" => wp_kses_data( __("URL of the testimonial source or author profile page", 'yogastudio') ),
...
// Add meta box
if (!function_exists('yogastudio_testimonial_add_override_options')) {
	//Handler of add_filter('trx_utils_filter_override_options', 'yogastudio_testimonial_add_override_options');
	function yogastudio_testimonial_add_override_options($boxes = array()) {
        $boxes[] = array_merge(yogastudio_storage_get('testimonial_override_options'), array('callback' => 'yogastudio_testimonial_show_override_options'));
        return $boxes;
	}
}

// Callback function to show fields in meta box
if (!function_exists('yogastudio_testimonial_show_override_options')) {
	function yogastudio_testimonial_show_override_options() {
		global $post;
		...
		$fields = yogastudio_storage_get_array('testimonial_override_options', 'fields');
		?>
...
if (!function_exists('yogastudio_testimonial_save_data')) {
	//Handler of add_action('save_post', 'yogastudio_testimonial_save_data');
	function yogastudio_testimonial_save_data($post_id) {
		// verify nonce
		if ( !wp_verify_nonce( yogastudio_get_value_gp('override_options_testimonial_nonce'), admin_url() ) )
			return $post_id;
...
if (!function_exists('yogastudio_sc_testimonials')) {
	function yogastudio_sc_testimonials($atts, $content=null){	
		...
		yogastudio_storage_set('sc_testimonials_data', array(
			'id' => $id,
            'style' => $style,
            'columns' => $columns,
            'counter' => 0,
...
if (!function_exists('yogastudio_sc_testimonials_item')) {
	function yogastudio_sc_testimonials_item($atts, $content=null){	
		...
		yogastudio_storage_inc_array('sc_testimonials_data', 'counter');
	
		$id = $id ? $id : (yogastudio_storage_get_array('sc_testimonials_data', 'id') ? yogastudio_storage_get_array('sc_testimonials_data', 'id') . '_' . yogastudio_storage_get_array('sc_testimonials_data', 'counter') : '');
	
		$thumb_sizes = yogastudio_get_thumb_sizes(array('layout' => yogastudio_storage_get_array('sc_testimonials_data', 'style')));
		...
		$args = array(
			'layout' => yogastudio_storage_get_array('sc_testimonials_data', 'style'),
			'number' => yogastudio_storage_get_array('sc_testimonials_data', 'counter'),
			'columns_count' => yogastudio_storage_get_array('sc_testimonials_data', 'columns'),
			'slider' => yogastudio_storage_get_array('sc_testimonials_data', 'slider'),
			'show' => false,
			'descr'  => 0,
			'tag_id' => $id,
			'tag_class' => $class,
			'tag_animation' => '',
			'tag_css' => $css,
			'tag_css_wh' => yogastudio_storage_get_array('sc_testimonials_data', 'css_wh'),
			'author' => $author,
			'position' => $position,
			'link' => $link,
			'email' => $email,
...
if (!function_exists('yogastudio_testimonials_reg_shortcodes')) {
	//Handler of add_filter('yogastudio_action_shortcodes_list',	'yogastudio_testimonials_reg_shortcodes');
	function yogastudio_testimonials_reg_shortcodes() {
		if (yogastudio_storage_isset('shortcodes')) {
			...
			yogastudio_sc_map_before('trx_title', array(
			
				// Testimonials
				"trx_testimonials" => array(
					"title" => esc_html__("Testimonials", 'yogastudio'),
					"desc" => wp_kses_data( __("Insert testimonials into post (page)", 'yogastudio') ),
					"decorate" => true,
					"container" => false,
					"params" => array(
						"title" => array(
						...
						"style" => array(
							...
							"desc" => wp_kses_data( __("Select style to display testimonials", 'yogastudio') ),
						...
						"columns" => array(
							...
							"desc" => wp_kses_data( __("How many columns use to show testimonials", 'yogastudio') ),
							"value" => 1,
							"min" => 1,
							"max" => 6,
							"step" => 1,
						...
						"slider" => array(
							...
							"desc" => wp_kses_data( __("Use slider to show testimonials", 'yogastudio') ),
							"value" => "yes",
							"type" => "switch",
						...
						"align" => array(
							...
							"desc" => wp_kses_data( __("Alignment of the testimonials block", 'yogastudio') ),
							"divider" => true,
							"value" => "",
							"type" => "checklist",
							"dir" => "horizontal",
						...
						"custom" => array(
							...
							"desc" => wp_kses_data( __("Allow get testimonials from inner shortcodes (custom) or get it from specified group (cat)", 'yogastudio') ),
							"divider" => true,
							"value" => "no",
							"type" => "switch",
							"options" => yogastudio_get_sc_param('yes_no')
						...
						"cat" => array(
							...
							"desc" => wp_kses_data( __("Select categories (groups) to show testimonials. If empty - select testimonials from any category (group) or from IDs list", 'yogastudio') ),
							"dependency" => array(
								'custom' => array('no')
							),
							"divider" => true,
						...
						"bg_color" => array(
							...
							"desc" => wp_kses_data( __("Any background color for this section", 'yogastudio') ),
							"value" => "",
							"type" => "color"
						),
						"bg_image" => array(
							"title" => esc_html__("Background image URL", 'yogastudio'),
							"desc" => wp_kses_data( __("Select or upload image or write URL from other site for the background", 'yogastudio') ),
							"readonly" => false,
							"value" => "",
							"type" => "media"
						),
						"bg_overlay" => array(
							...
							"desc" => wp_kses_data( __("Overlay color opacity (from 0.0 to 1.0)", 'yogastudio') ),
							"min" => "0",
							"max" => "1",
							"step" => "0.1",
							"value" => "0",
						...
						"bg_texture" => array(
							...
							"desc" => wp_kses_data( __("Predefined texture style from 1 to 11. 0 - without texture.", 'yogastudio') ),
							"min" => "0",
							"max" => "11",
							"step" => "1",
							"value" => "0",
					...
					"children" => array(
						...
						"desc" => wp_kses_data( __("Testimonials item (custom parameters)", 'yogastudio') ),
						"container" => true,
						"params" => array(
							"author" => array(
								"title" => esc_html__("Author", 'yogastudio'),
								"desc" => wp_kses_data( __("Name of the testimonmials author", 'yogastudio') ),
								"value" => "",
								"type" => "text"
							),
							"link" => array(
								"title" => esc_html__("Link", 'yogastudio'),
								"desc" => wp_kses_data( __("Link URL to the testimonmials author page", 'yogastudio') ),
								"value" => "",
								"type" => "text"
							),
							"email" => array(
								"title" => esc_html__("E-mail", 'yogastudio'),
								"desc" => wp_kses_data( __("E-mail of the testimonmials author (to get gravatar)", 'yogastudio') ),
								"value" => "",
								"type" => "text"
							),
							"photo" => array(
								"title" => esc_html__("Photo", 'yogastudio'),
								"desc" => wp_kses_data( __("Select or upload photo of testimonmials author or write URL of photo from other site", 'yogastudio') ),
								"value" => "",
								"type" => "media"
							),
							"_content_" => array(
								"title" => esc_html__("Testimonials text", 'yogastudio'),
								"desc" => wp_kses_data( __("Current testimonials text", 'yogastudio') ),
								"divider" => true,
								"rows" => 4,
								"value" => "",
								"type" => "textarea"
...
if (!function_exists('yogastudio_testimonials_reg_shortcodes_vc')) {
	//Handler of add_filter('yogastudio_action_shortcodes_list_vc',	'yogastudio_testimonials_reg_shortcodes_vc');
	function yogastudio_testimonials_reg_shortcodes_vc() {
		...
		vc_map( array(
				...
				"description" => wp_kses_data( __("Insert testimonials slider", 'yogastudio') ),
				...
				"params" => array(
					array(
						...
						"description" => wp_kses_data( __("Select style to display testimonials", 'yogastudio') ),
						"class" => "",
						"admin_label" => true,
					...
					array(
						...
						"description" => wp_kses_data( __("Alignment of the testimonials block", 'yogastudio') ),
						"class" => "",
					...
					array(
						...
						"description" => wp_kses_data( __("Allow get testimonials from inner shortcodes (custom) or get it from specified group (cat)", 'yogastudio') ),
						"class" => "",
					...
					array(
						...
						"description" => wp_kses_data( __("Select categories (groups) to show testimonials. If empty - select testimonials from any category (group) or from IDs list", 'yogastudio') ),
					...
					array(
						...
						"description" => wp_kses_data( __("How many columns use to show testimonials", 'yogastudio') ),
						"group" => esc_html__('Query', 'yogastudio'),
						"admin_label" => true,
						"class" => "",
						"value" => "1",
					...
					array(
						...
						"description" => wp_kses_data( __("Comma separated list of posts ID. If set - parameters above are ignored!", 'yogastudio') ),
						"group" => esc_html__('Query', 'yogastudio'),
						'dependency' => array(
							'element' => 'custom',
							'is_empty' => true
					...
					array(
						...
						"description" => wp_kses_data( __("Any background color for this section", 'yogastudio') ),
						"group" => esc_html__('Colors and Images', 'yogastudio'),
						"class" => "",
						"value" => "",
						"type" => "colorpicker"
					...
					array(
						...
						"description" => wp_kses_data( __("Select background image from library for this section", 'yogastudio') ),
						"group" => esc_html__('Colors and Images', 'yogastudio'),
						"class" => "",
						"value" => "",
						"type" => "attach_image"
					...
					array(
						...
						"description" => wp_kses_data( __("Overlay color opacity (from 0.0 to 1.0)", 'yogastudio') ),
						"group" => esc_html__('Colors and Images', 'yogastudio'),
						"class" => "",
						"value" => "",
						"type" => "textfield"
					...
					array(
						...
						"description" => wp_kses_data( __("Texture style from 1 to 11. Empty or 0 - without texture.", 'yogastudio') ),
						"group" => esc_html__('Colors and Images', 'yogastudio'),
						"class" => "",
						"value" => "",
						"type" => "textfield"
		...
		vc_map( array(
				...
				"description" => wp_kses_data( __("Single testimonials item", 'yogastudio') ),
				"show_settings_on_create" => true,
				...
				"params" => array(
					array(
						...
						"description" => wp_kses_data( __("Name of the testimonmials author", 'yogastudio') ),
						"admin_label" => true,
						"class" => "",
						"value" => "",
						"type" => "textfield"
					...
					array(
						...
						"description" => wp_kses_data( __("Link URL to the testimonmials author page", 'yogastudio') ),
						"class" => "",
						"value" => "",
						"type" => "textfield"
					),
					array(
						...
						"description" => wp_kses_data( __("E-mail of the testimonmials author", 'yogastudio') ),
						"class" => "",
						"value" => "",
						"type" => "textfield"
					),
					array(
						...
						"description" => wp_kses_data( __("Select or upload photo of testimonmials author or write URL of photo from other site", 'yogastudio') ),
						"class" => "",
						"value" => "",
						"type" => "attach_image"
					),
					...
					array(
						...
						"description" => wp_kses_data( __("Current testimonials text", 'yogastudio') ),
						"class" => "",
						"value" => "",
						"type" => "textarea_html"
					),
