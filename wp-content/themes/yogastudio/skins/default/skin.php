...
if (!function_exists('yogastudio_action_skin_add_responsive')) {
	...
	function yogastudio_action_skin_add_responsive() {
		if (file_exists(yogastudio_get_file_dir('skin.responsive.css'))) 
			wp_enqueue_style( 'theme-skin-responsive-style', yogastudio_get_file_url('skin.responsive.css'), array(), null );
	}
}
