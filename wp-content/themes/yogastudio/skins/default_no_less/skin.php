...
if (!function_exists('yogastudio_action_skin_theme_setup')) {
	...
	function yogastudio_action_skin_theme_setup() {
		...
		yogastudio_set_theme_setting('less_compiler', 'no');
		// Disable customizer demo
		yogastudio_set_theme_setting('customizer_demo', false);
...
//			'accent3_hover'			=> '',
		...
		yogastudio_add_color_scheme('contrast', array(

			'title'		 =>	esc_html__('Contrast', 'yogastudio'),
...
//			'accent3_hover'			=> '',
		...
		yogastudio_add_color_scheme('modern', array(

			'title'		 =>	esc_html__('Modern', 'yogastudio'),
...
//			'accent3_hover'			=> '',
		...
		yogastudio_add_color_scheme('pastel', array(

			'title'		 =>	esc_html__('Pastel', 'yogastudio'),
...
if (!function_exists('yogastudio_filter_skin_used_fonts')) {
	//Handler of add_filter('yogastudio_filter_used_fonts', 'yogastudio_filter_skin_used_fonts');
...
if (!function_exists('yogastudio_filter_skin_list_fonts')) {
	//Handler of add_filter('yogastudio_filter_list_fonts', 'yogastudio_filter_skin_list_fonts');
...
if (!function_exists('yogastudio_action_skin_add_styles')) {
	//Handler of add_action('yogastudio_action_add_styles', 'yogastudio_action_skin_add_styles');
	function yogastudio_action_skin_add_styles() {
		// Add stylesheet files
		wp_enqueue_style( 'yogastudio-skin-style', yogastudio_get_file_url('skin.css'), array(), null );
		if (file_exists(yogastudio_get_file_dir('skin.customizer.css')))
			wp_enqueue_style( 'yogastudio-skin-customizer-style', yogastudio_get_file_url('skin.customizer.css'), array(), null );
	}
}

// Add skin inline styles
if (!function_exists('yogastudio_filter_skin_add_styles_inline')) {
	//Handler of add_filter('yogastudio_filter_add_styles_inline', 'yogastudio_filter_skin_add_styles_inline');
	function yogastudio_filter_skin_add_styles_inline($custom_style) {
		...
		//			';
		//		}
		$clr = yogastudio_get_scheme_colors();
		$clr['accent1_rgb'] = yogastudio_hex2rgb($clr['accent1']);
		$clr['accent1_hover_rgb'] = yogastudio_hex2rgb($clr['accent1_hover']);
		$fnt = yogastudio_get_custom_fonts_properties();
		$css = '

body {
	'.yogastudio_get_custom_font_css('p').';
}

h1 { '.yogastudio_get_custom_font_css('h1').'; '.yogastudio_get_custom_margins_css('h1').'; }
h2 { '.yogastudio_get_custom_font_css('h2').'; '.yogastudio_get_custom_margins_css('h2').'; }
h3 { '.yogastudio_get_custom_font_css('h3').'; '.yogastudio_get_custom_margins_css('h3').'; }
h4 { '.yogastudio_get_custom_font_css('h4').'; '.yogastudio_get_custom_margins_css('h4').'; }
h5 { '.yogastudio_get_custom_font_css('h5').'; '.yogastudio_get_custom_margins_css('h5').'; }
h6 { '.yogastudio_get_custom_font_css('h6').'; '.yogastudio_get_custom_margins_css('h6').'; }
a,
.scheme_dark a,
.scheme_light a {
	'.yogastudio_get_custom_font_css('link').';
	color: '.$clr['accent1'].';
}
a:hover,
.scheme_dark a:hover,
...
select,
textarea {
	'.yogastudio_get_custom_font_css('input').';
}
...
.top_panel_middle .logo {
	'.yogastudio_get_custom_margins_css('logo').';
}
.logo .logo_text {
	'.yogastudio_get_custom_font_css('logo').';
}
...
.menu_main_nav > li > a {
	...
	'.yogastudio_get_custom_font_css('menu').';
}
...
.menu_main_nav > li ul {
	'.yogastudio_get_custom_font_css('submenu').';
}
.menu_main_nav > li > ul {
...
.post_info {
	'.yogastudio_get_custom_font_css('info').';
	'.yogastudio_get_custom_margins_css('info').';
}
...
button,
.sc_button {
	'.yogastudio_get_custom_font_css('button').';
}
input[type="submit"],
input[type="reset"],
input[type="button"],
...
if (!function_exists('yogastudio_action_skin_add_responsive')) {
	//Handler of add_action('yogastudio_action_add_responsive', 'yogastudio_action_skin_add_responsive');
	function yogastudio_action_skin_add_responsive() {
		...
		if (file_exists(yogastudio_get_file_dir('skin.responsive'.($suffix).'.css'))) 
			wp_enqueue_style( 'theme-skin-responsive-style', yogastudio_get_file_url('skin.responsive'.($suffix).'.css'), array(), null );
	}
}

// Add skin responsive inline styles
if (!function_exists('yogastudio_filter_skin_add_responsive_inline')) {
	//Handler of add_filter('yogastudio_filter_add_responsive_inline', 'yogastudio_filter_skin_add_responsive_inline');
...
if (!function_exists('yogastudio_filter_skin_compile_less')) {
	//Handler of add_filter('yogastudio_filter_compile_less', 'yogastudio_filter_skin_compile_less');
...
if (!function_exists('yogastudio_action_skin_add_scripts')) {
	//Handler of add_action('yogastudio_action_add_scripts', 'yogastudio_action_skin_add_scripts');
	function yogastudio_action_skin_add_scripts() {
		if (file_exists(yogastudio_get_file_dir('skin.js')))
			wp_enqueue_script( 'theme-skin-script', yogastudio_get_file_url('skin.js'), array(), null );
		if (yogastudio_get_theme_option('show_theme_customizer') == 'yes' && file_exists(yogastudio_get_file_dir('skin.customizer.js')))
			wp_enqueue_script( 'theme-skin-customizer-script', yogastudio_get_file_url('skin.customizer.js'), array(), null );
	}
}
