...
if (!function_exists('yogastudio_taxonomy_add_options_column')) {
	//Handler of add_filter('manage_edit-taxonomy_columns',	'yogastudio_taxonomy_add_options_column', 9);
...
if (!function_exists('yogastudio_taxonomy_show_custom_fields')) {
	function yogastudio_taxonomy_show_custom_fields($tax_obj = null) {
		...
		do_action('yogastudio_action_taxonomy_before_show_override_options', $tax_type, $tax_obj);

		$data = yogastudio_storage_get('options');
		...
		do_action('yogastudio_action_taxonomy_after_show_override_options', $tax_type, $tax_obj);
		?>
			</td>
		</tr>
		</table>
...
if (!function_exists('yogastudio_taxonomy_save_custom_fields')) {
	function yogastudio_taxonomy_save_custom_fields( $term_id=0 ) {
		...
		// verify nonce
		if ( !wp_verify_nonce( yogastudio_get_value_gp('override_options_taxonomy_nonce'), admin_url() ) )
			return $term_id;
		...
		if (yogastudio_options_merge_new_values(yogastudio_storage_get('options'), $custom_options, $_POST, 'save', $override_key))
...
if (!function_exists('yogastudio_taxonomy_load_custom_options')) {
	function yogastudio_taxonomy_load_custom_options($tax_obj, $tax_type = '') {  
		...
		return apply_filters('yogastudio_filter_taxonomy_load_custom_options', $t_id ? get_option( yogastudio_storage_get('options_prefix') . "_options_taxonomy_{$t_id}" ) : false, $tax_type, $tax_obj);
	}
}
