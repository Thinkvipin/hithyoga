...
if (!function_exists('yogastudio_attachment_ajax_query_args')) {
	//Handler of add_filter('ajax_query_attachments_args', 'yogastudio_attachment_ajax_query_args');
...
if (!function_exists('yogastudio_attachment_view_filters')) {
	//Handler of add_filter('media_view_settings', 'yogastudio_attachment_view_filters');
...
if (!function_exists('yogastudio_attachment_view_compat')) {
	//Handler of add_filter('attachment_fields_to_edit', 'yogastudio_attachment_view_compat');
...
if (!function_exists('yogastudio_attachment_save_compat')) {
	//Handler of add_filter( 'attachment_fields_to_save', 'yogastudio_attachment_save_compat');
...
if ( !function_exists( 'yogastudio_attachmnent_detect_inheritance_key' ) ) {
	//Handler of add_filter('yogastudio_filter_detect_inheritance_key',	'yogastudio_attachmnent_detect_inheritance_key', 9, 1);
	function yogastudio_attachmnent_detect_inheritance_key($key) {
		if (!empty($key)) return $key;
		return (!yogastudio_storage_empty('pre_query') ? yogastudio_storage_call_obj_method('pre_query', 'is_attachment') : is_attachment())
					? 'attachment' 
					: '';
	}
}
