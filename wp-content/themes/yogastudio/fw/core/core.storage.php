<?php
/**
 * Yogastudio Framework: theme variables storage
 *
 * @package	yogastudio
...
if (!function_exists('yogastudio_storage_global_vars')) {
    function yogastudio_storage_global_vars($variable) {
...
if (!function_exists('yogastudio_storage_merge_array')) {
    function yogastudio_storage_merge_array($var_name, $key, $arr) {
        global $YOGASTUDIO_STORAGE;
        if (!isset($YOGASTUDIO_STORAGE[$var_name])) $YOGASTUDIO_STORAGE[$var_name] = array();
        if (!isset($YOGASTUDIO_STORAGE[$var_name][$key])) $YOGASTUDIO_STORAGE[$var_name][$key] = array();
        $YOGASTUDIO_STORAGE[$var_name][$key] = array_merge($YOGASTUDIO_STORAGE[$var_name][$key], $arr);
    }
}
?>