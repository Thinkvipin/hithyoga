		...
		<div class="sc_scroll_wrapper swiper-wrapper">
			<div class="sc_scroll_slide swiper-slide">
				...
				<div class="co_section">
					<div class="co_label"><?php esc_html_e('Body styles', 'yogastudio'); ?></div>
					<div class="co_switch_box co_switch_horizontal co_switch_columns_2<?php /* co_switch_vertical|horizontal,co_switch_columns_3|4 */ ?>" data-options="body_style">
						...
						<a href="#" data-value="boxed"><?php esc_html_e('Boxed', 'yogastudio'); ?></a>
						<a href="#" data-value="wide"><?php esc_html_e('Wide', 'yogastudio'); ?></a>
					</div>
				</div>
				...
				<div class="co_section">
					<div class="co_label"><?php esc_html_e('Background pattern', 'yogastudio'); ?></div>
					<div id="co_bg_pattern_list" class="co_image_check" data-options="bg_pattern">
						<?php
						for ($i=1; $i<=5; $i++) {
							$pattern = yogastudio_get_file_url('images/bg/pattern_'.intval($i).'.jpg');
							$thumb   = yogastudio_get_file_url('images/bg/pattern_'.intval($i).'_thumb.jpg');
							?>
