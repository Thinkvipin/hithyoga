...
if (!function_exists('yogastudio_get_date_translations')) {
	function yogastudio_get_date_translations($dt) {
		return str_replace(
			...
			array(
				esc_html__('January', 'yogastudio'),
				esc_html__('February', 'yogastudio'),
				esc_html__('March', 'yogastudio'),
				esc_html__('April', 'yogastudio'),
				esc_html__('May', 'yogastudio'),
				esc_html__('June', 'yogastudio'),
				esc_html__('July', 'yogastudio'),
				esc_html__('August', 'yogastudio'),
				esc_html__('September', 'yogastudio'),
				esc_html__('October', 'yogastudio'),
				esc_html__('November', 'yogastudio'),
				esc_html__('December', 'yogastudio'),
