...
if (window.dal===undefined) function dal(s) { if (YOGASTUDIO_STORAGE['user_logged_in']) alert(s); }
if (window.dao===undefined) function dao(s,h,r) { if (YOGASTUDIO_STORAGE['user_logged_in']) alert(yogastudio_debug_object(s,h,r)); }
